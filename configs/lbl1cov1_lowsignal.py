...
RULES_COV_TO_GEN = {
    ...
    'lbl_lesion':{
        True:{ 
            'shape-midr_curv'    :dict(amt=(3,2,2,2,1,1,1,1,1)), 
            'shape-midr_vol-rad' :dict(amt=(1,1,2,3))},
        False:{ 
            'shape-midr_curv'    :dict(amt=(1,1,1,1,1,2,2,2,3)), 
            'shape-midr_vol-rad' :dict(amt=(3,2,1,1))},
    },
}
